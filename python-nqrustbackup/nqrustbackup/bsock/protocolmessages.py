...
"""
Protocol messages between nqrustbackup-director and user-agent.
"""

from nqrustbackup import __version__
...
class ProtocolMessages:
    """
    strings defined by the protocol to talk to the NQRustBackup Director.
    """
    ...
    def hello(self, name, type=ConnectionType.DIRECTOR):
        if type == ConnectionType.FILEDAEMON:
            ...
            if self.protocolversion < ProtocolVersions.nqrustbackup_18_2:
