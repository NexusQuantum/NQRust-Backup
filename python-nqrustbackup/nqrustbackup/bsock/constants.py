...
#
#   Copyright (C) 2015-2020 NQRustBackup GmbH & Co. KG
#
...
"""Constants used by NQRustBackup."""
...
class Constants:
    ...
    # https://github.com/nqrustbackup/nqrustbackup/blob/master/core/src/lib/bsock.h
    ...
    def get_description(code):
        """Get a description text for a NQRustBackup constant.

        Args:
           code (int): NQRustBackup ``BNET`` constant.

        Returns:
            str: Description for a NQRustBackup ``BNET`` constant or ``None`` if no description exists.
        """
        try:
