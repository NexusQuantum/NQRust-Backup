...
Url:            https://github.com/nqrustbackup/python-nqrustbackup/
Group:          Productivity/Archiving/Backup
Vendor:         The NQRustBackup Team
...
NQRustBackup - Backup Archiving Recovery Open Sourced - Python module

This packages contains a python module to interact with a NQRustBackup backup system.
