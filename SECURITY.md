...
If you find a security-related problem in NQRustBackup, please report it via e-mail to security@nqrustbackup.org.
We will try to respond to you within two days.
Please be patient with us.

Together with you, we will then determine a CVSS score and find out which versions of NQRustBackup are vulnerable.
