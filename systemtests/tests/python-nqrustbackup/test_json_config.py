...
class PythonNQRustBackupJsonConfigTest(nqrustbackup_unittest.Json):
    def test_show_command(self):
        ...
        try:
            os.remove("etc/nqrustbackup/nqrustbackup-dir.d/client/{}.conf".format(newclient))
    ...
    def test_configure_add_with_quotes(self):
        ...
        try:
            os.remove("etc/nqrustbackup/nqrustbackup-dir.d/job/{}.conf".format(testname))
            director.call("reload")
        except OSError:
            pass
    ...
    def _test_configure_add_conole_with_where_acl(self, name, where_acl):
        ...
        try:
            os.remove("etc/nqrustbackup/nqrustbackup-dir.d/{}/{}.conf".format(resourcetype, name))
            director.call("reload")
        except OSError:
            pass
