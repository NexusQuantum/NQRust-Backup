...
class PythonNQRustBackupTlsPskTest(nqrustbackup_unittest.Base):
    """
    This test used the default protocol
    (opposite to the PythonNQRustBackupProtocol124Test class,
    which uses ProtocolVersions.nqrustbackup_12_4).
    However, on authentication failures,
    DirectorConsole falls back to ProtocolVersions.nqrustbackup_12_4.
