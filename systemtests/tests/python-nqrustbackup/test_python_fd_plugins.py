...
class NQRustBackupFdPythonPluginOptions(nqrustbackup_unittest.Json):
    def test_without_extra_pluginoptions(self):
        ...
        jobname = "backup-nqrustbackup-fd-pluginoptions"
    ...
    def test_overwrite_pluginoptions(self):
        ...
        already defined in the NQRustBackup director fileset configuration.
