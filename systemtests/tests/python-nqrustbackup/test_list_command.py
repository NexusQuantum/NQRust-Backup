...
class PythonNQRustBackupListCommandTest(nqrustbackup_unittest.Json):
    def test_list_jobs(self):
        ...
        backup_jobname = "backup-nqrustbackup-fd"
        backup_jobid = self.get_backup_jobid(director, backup_jobname, level="Full")
        self.run_restore(director, client="nqrustbackup-fd", jobid=backup_jobid, wait=True)
        ...
        jobid = self.run_job(director, "backup-nqrustbackup-fd")
    ...
    def test_list_media(self):
        ...
        self.get_backup_jobid(director, "backup-nqrustbackup-fd", level="Full")
    ...
    def test_list_pool(self):
        ...
        self.get_backup_jobid(director, "backup-nqrustbackup-fd")
    ...
    def test_list_files(self):
        ...
        # Before fixing https://bugs.nqrustbackup.org/view.php?id=1007 the keys could be scrambled after 100 entries.
    ...
    def test_list_joblog(self):
        ...
        jobid = self.get_backup_jobid(director=director, jobname="backup-nqrustbackup-fd")
