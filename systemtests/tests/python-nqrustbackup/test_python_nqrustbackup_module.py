...
class PythonNQRustBackupModuleTest(nqrustbackup_unittest.Base):
    ...
    def test_exception_connection_error(self):
        ...
        try:
            raise nqrustbackup.exceptions.ConnectionError("my test message")
    ...
    def test_exception_signal_received(self):
        ...
        try:
            raise nqrustbackup.exceptions.SignalReceivedException(Constants.BNET_TERMINATE)
    ...
    def test_password(self):
        password = nqrustbackup.bsock.Password("secret")
        md5 = password.md5()
