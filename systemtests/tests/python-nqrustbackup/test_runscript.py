...
class PythonNQRustBackupJsonRunScriptTest(nqrustbackup_unittest.Json):
    def test_backup_runscript_client_defaults(self):
        ...
        jobname = "backup-nqrustbackup-fd-runscript-client-defaults"
        level = None
        ...
        #    "logtext": "nqrustbackup-dir JobId 76: BeforeJob: jobname=admin-runscript-server\n"
        # },
    ...
    def test_backup_runscript_client(self):
        ...
        jobname = "backup-nqrustbackup-fd-runscript-client"
        level = None
        expected_log = ": ClientBeforeJob: jobname={}".format(jobname)
        ...
        # {
        #    "time": "2019-12-02 00:07:34",
        #    "logtext": "nqrustbackup-dir JobId 76: ClientBeforeJob: jobname=admin-runscript-server\n"
        # },
    ...
    def test_backup_runscript_server(self):
        ...
        jobname = "backup-nqrustbackup-fd-runscript-server"
        level = None
        expected_logs = [
            ": BeforeJob: jobname={}".format(jobname),
            ": BeforeJob: daemon=nqrustbackup-dir",
        ]
    ...
    def test_backup_runscript_console_client(self):
        ...
        jobname = "backup-nqrustbackup-fd-runscript-console-client"
        level = None
        expected_logs = [
    ...
    def test_backup_runscript_console_server(self):
        ...
        jobname = "backup-nqrustbackup-fd-runscript-console-server"
        level = None
        expected_logs = [
            'console command: run BeforeJob "version"',
        ]
    ...
    def test_admin_runscript_server_failure_implicit(self):
        ...
        #   "logtext": "nqrustbackup-dir JobId 6: Error: Runscript: BeforeJob returned non-zero status=1. ERR=Child exited with code 1\n"
        # },
    ...
    def test_admin_runscript_console_server_defaults(self):
        ...
        #   "logtext": "nqrustbackup-dir JobId 3: console command: run BeforeJob \"whoami\"\n"
        # },
        # {
        #   "time": "2022-08-10 13:14:20",
        #   "logtext": "nqrustbackup-dir JobId 3: console command: run BeforeJob \"version\"\n"
        # },
        # {
        #   "time": "2022-08-10 13:14:20",
        #   "logtext": "nqrustbackup-dir JobId 3: console command: run BeforeJob \"list jobid=3\"\n"
        # },
    ...
    def test_admin_runscript_console_server_invalid(self):
        ...
        #   "logtext": "nqrustbackup-dir JobId 6: console command: run BeforeJob \"list jobid=6\"\n"
        # },
        # {
        #   "time": "2022-08-10 13:21:21",
        #   "logtext": "nqrustbackup-dir JobId 6: console command: run BeforeJob \"INVALID\"\n"
        # },
    ...
    def test_admin_runscript_client(self):
        ...
        # "logtext": "nqrustbackup-dir JobId 7: Warning: Invalid runscript definition (command=...). Admin Jobs only support local runscripts.\n"
        # },
