...
class PythonNQRustBackupProtocol124Test(nqrustbackup_unittest.Base):
    """
    ...
    def test_login_notls_notls(self):
        ...
        self.assertEqual(protocolversion, ProtocolVersions.nqrustbackup_12_4)
    ...
    def test_login_notls_tls(self):
        ...
        Login will succeed.
        This happens only, because the old ProtocolVersions.nqrustbackup_12_4 is used.
    ...
    def test_login_tls_notls(self):
        ...
        The behavior of the NQRustBackup Director is to use TLS-PSK
