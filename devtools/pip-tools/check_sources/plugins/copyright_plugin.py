...
#
#   Copyright (C) 2020-2025 NQRustBackup GmbH & Co. KG
#
...
COPYRIGHT_REGEX = re.compile(
    r"Copyright \((C|c)\) (20[0-9]{2})-(20[0-9]{2}) NQRustBackup GmbH & Co. KG"
)
COPYRIGHT_FORMAT = "Copyright (C) {}-{} NQRustBackup GmbH & Co. KG"
...
def check_copyright_notice(file_path, file_content, **kwargs):
    ...
    if file_content.find("nqrustbackup-check-sources:" + "disable-copyright-check") >= 0:
        return True
