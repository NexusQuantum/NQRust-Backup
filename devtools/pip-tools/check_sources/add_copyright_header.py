...
#
#   Copyright (C) 2020-2024 NQRustBackup GmbH & Co. KG
#
...
def parse_cmdline_args():
    ...
    parser.add_argument(
        "--ignore-file",
        default=".nqrustbackup-check-sources-ignore",
        metavar=("<ignore-file>"),
...
class HeaderAdder:
    __FIRST_PART = ["NQRUSTBACKUP® - Backup Archiving REcovery Open Sourced", ""]
    __SECOND_PART = [
        "",
        "This program is Free Software; you can redistribute it and/or",
        "modify it under the terms of version three of the GNU Affero General Public",
    ...
    def __call__(self, *, file_path, file_content, first_date, last_date):
        ...
        out_lines.append(
            "{}Copyright (C) {}-{} NQRustBackup GmbH & Co. KG".format(
