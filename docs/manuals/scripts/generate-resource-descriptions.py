...
#
#   Copyright (C) 2018-2024 NQRustBackup GmbH & Co. KG
#
...
class daemonName:
    ...
    def getShort(string):
        if (
            string.lower() == "nqrustbackup-dir"
            or string.lower() == "director"
            or string.lower() == "dir"
        ):
            return "Dir"
        elif (
            string.lower() == "nqrustbackup-sd"
            or string.lower() == "storagedaemon"
            or string.lower() == "sd"
        ):
            return "Sd"
        elif (
            string.lower() == "nqrustbackup-fd"
            or string.lower() == "filedaemon"
            or string.lower() == "fd"
        ):
            return "Fd"
        elif (
            string.lower() == "nqrustbackup-console"
            or string.lower() == "nqrustbackup_console"
            or string.lower() == "con"
        ):
            return "Console"
        elif string.lower() == "nqrustbackup-tray-monitor":
            return "Console"
...
class NQRustBackupConfigurationSchema:
    ...
    def getResourceDirective(self, daemon, resourcename, directive, deprecated=None):
        ...
        return NQRustBackupConfigurationSchemaDirective(
...
class NQRustBackupConfigurationSchemaDirective(dict):
...
class NQRustBackupConfigurationSchema2Sphinx(NQRustBackupConfigurationSchema):
    ...
    def getRows(self, daemon, resourcename, subtree, link):
        ...
        for key in sorted(filter(None, subtree.keys())):
            data = NQRustBackupConfigurationSchemaDirective(subtree[key])
...
def createSphinx(data):
    ...
    sphinx = NQRustBackupConfigurationSchema2Sphinx(data)
