...
"""
Generate-nqrustbackup-package-info: generate latex tables from a json data structure.
...
__license__ = "AGPL"
__version__ = "0.3"
__email__ = "joerg.steffens@nqrustbackup.com"
...
if __name__ == "__main__":
    ...
    for filename in args.filename:
        release = re.sub(".*nqrustbackup-([0-9.]+)-packages.json", r"\1", filename)
    ...
    basename = "nqrustbackup-packages"
