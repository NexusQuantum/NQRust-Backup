.. _documentationstyleguide/nqrustbackupspecificformatting/nqrustbackupconfiguration:nqrustbackup configuration:

NQRustBackup Configuration
====================

.. _documentationstyleguide/nqrustbackupspecificformatting/nqrustbackupconfiguration:nqrustbackup configuration resource:

NQRustBackup Configuration Resource
-----------------------------

To display a NQRustBackup specific resource configuration file, use a code block:
...
The *caption* shows the relevant path where to expect the configuration resource:
   ...
   #. <daemon>\ :file:`.d/` (nqrustbackup-dir.d, nqrustbackup-sd.d, nqrustbackup-fd.d, ...)
   #. <resource type>\ :file:`/`
...
.. note::
   ...
   Remember to start each code-block line by 3 indenting spaces. However, the code itself is indented by the rules of the resource (2 spaces for NQRustBackup configuration resources).
...
::
   ...
   .. literalinclude:: /include/config/nqrustbackup-sd.d/device/FileStorage.conf
...
Normally, these snippets contain a complete NQRustBackup configuration resource.
...
.. _documentationstyleguide/nqrustbackupspecificformatting/nqrustbackupconfiguration:resource name:
...
.. _documentationstyleguide/nqrustbackupspecificformatting/nqrustbackupconfiguration:resource directive definition:

Resource Directive Definition
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The documentation outline for resource directives is autogenerated
(by https://github.com/nqrustbackup/nqrustbackup/blob/master/docs/manuals/scripts/generate-resource-descriptions.py)
and stored into the
https://github.com/nqrustbackup/nqrustbackup/tree/master/docs/manuals/source/include/autogenerated/
directory.
...
.. _documentationstyleguide/nqrustbackupspecificformatting/nqrustbackupconfiguration:reference to a resource directive:
...
.. note::
   ...
   :ref:`DocumentationStyleGuide/NQRustBackupSpecificFormatting/NQRustBackupConfiguration:Resource Directive Definition`,
...
.. _documentationstyleguide/nqrustbackupspecificformatting/nqrustbackupconfiguration:resource directive with value:
