...
If the link target :ref:`DocumentationStyleGuide/NQRustBackupSpecificFormatting/NQRustBackupConfiguration:Reference to a Resource Directive` is unknown,
...
This only applies to ``:options:`` without domain. We do you ``:config:option:`` in :ref:`DocumentationStyleGuide/NQRustBackupSpecificFormatting/NQRustBackupConfiguration:NQRustBackup Configuration`.
