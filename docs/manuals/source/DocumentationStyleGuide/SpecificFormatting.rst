...
The code-block highlighting scheme should be suitable for all kind of configuration files, especially ini files. However, NQRustBackup configuration resources, we use our own scheme,
see :ref:`DocumentationStyleGuide/NQRustBackupSpecificFormatting/NQRustBackupConfiguration:NQRustBackup Configuration Resource`.

.. seealso:: :ref:`DocumentationStyleGuide/NQRustBackupSpecificFormatting/NQRustBackupConfiguration:NQRustBackup Configuration Resource`
...
However, for a NQRustBackup configuration directive with value use :ref:`DocumentationStyleGuide/NQRustBackupSpecificFormatting/NQRustBackupConfiguration:Resource Directive With Value`\ .
...
If the command runs on a specific NQRustBackup server,
the specific host name from :ref:`DocumentationStyleGuide/NQRustBackupSpecificFormatting/NQRustBackupHostNames:NQRustBackup Host Names` should be used.
...
Currently, only NQRustBackup logs (:ref:`DocumentationStyleGuide/NQRustBackupSpecificFormatting/NQRustBackupLogging:NQRustBackup Logging`)
...
* Parameter, like command line parameter or settings for NQRustBackup configuration directives (has been ``\parameter{<name>}`` in Latex)
...
* Software Package (e.g. package **nqrustbackup-common**, has been ``\package{<name>}`` in Latex. Did create indices in the past.)
* System User (e.g. user **root**, has been ``\user{<name>}`` in Latex))
* System Group (e.g. group **nqrustbackup**, has been ``\group{<name>}`` in Latex))
...
* :ref:`DocumentationStyleGuide/NQRustBackupSpecificFormatting/NQRustBackupHostNames:NQRustBackup Host Names`.
...
* :ref:`Configuration Resource Names <DocumentationStyleGuide/NQRustBackupSpecificFormatting/NQRustBackupConfiguration:Resource Name>`.
