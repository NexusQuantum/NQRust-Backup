...
The NQRustBackup project provides packages, published at https://download.nqrustbackup.org/ and https://download.nqrustbackup.com/.
...
.. list-table::
   ...
   * - :index:`Arch Linux <single: Platform; Arch Linux>`
     -
     - `X <https://aur.archlinux.org/pkgbase/nqrustbackup/>`__
     - `X <https://aur.archlinux.org/pkgbase/nqrustbackup/>`__
     - `X <https://aur.archlinux.org/pkgbase/nqrustbackup/>`__
   * - CentOS
     - current
   ...
   * - :index:`Gentoo <single: Platform; Gentoo>`
     - 
     - `X <https://packages.gentoo.org/packages/app-backup/nqrustbackup>`__
     - `X <https://packages.gentoo.org/packages/app-backup/nqrustbackup>`__
     - `X <https://packages.gentoo.org/packages/app-backup/nqrustbackup>`__
   * - openSUSE
     - current
...
.. list-table::
   ...
   * - **vVV.V**
     - starting with NQRustBackup version VV.V, this platform is official supported by the NQRustBackup.org project
   * - **com-VV.V**
     - starting with NQRustBackup version VV.V, this platform is supported. However, pre-build packages are only available from NQRustBackup.com
   * - **X**
     - known to work
   * - **\***
