...
For pgtune the DB type of the NQRustBackup catalog  database is a "Data Warehouse".


The file table
~~~~~~~~~~~~~~

The by far **biggest table** in the NQRustBackup catalog database is the **file** table.
...
To have optimum performance, the **memory available** for the NQRustBackup catalog database should be at least the **size of the file and path table indexes**.
...
During backups with NQRustBackup, the amount of CPU consumed is influenced by different parameters.
