...
NQRustBackup stores its information in a database, named Catalog. It is configured by :ref:`DirectorResourceCatalog`.
...
The status of a NQRustBackup job is stored as abbreviation in the Catalog database table Job. It is also displayed by some nqrustbackup_console commands, eg. :bcommand:`list jobs`.
