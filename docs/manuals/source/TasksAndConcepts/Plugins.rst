...
The functionality of NQRustBackup can be extended by plugins. Plugins exist
...
The program :ref:`nqrustbackup_pluginfo` can be used to retrieve information about a specific plugin.
...
With NQRustBackup :sinceVersion:`23: Python API`,
