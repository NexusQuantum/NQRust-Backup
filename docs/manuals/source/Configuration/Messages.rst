...
destination = address = message-type1, message-type2, message-type3, ...
   ...
   :ref:`message-type <MessageTypes>`
      is one of a predefined set of keywords that define the type of message generated by NQRustBackup: ERROR, WARNING, FATAL, ...
...
.. include:: /include/autogenerated/nqrustbackup-dir-resource-messages-table.rst.inc

.. include:: /include/autogenerated/nqrustbackup-dir-resource-messages-description.rst.inc
...
audit
   |
   | :index:`\ <single: Messages; type; audit>`\  :index:`\ <single: auditing>`\  Audit messages. Interacting with the NQRustBackup Director will be audited. Can be configured with in resource :config:option:`dir/director/Auditing`\ .
...
.. code-block:: nqrustbackupconfig
   ...
   Messages {
     Name = Standard
     Mail Command = "/usr/sbin/nqrustbackup_smtp -h mail.example.com  -f \"\(NQRustBackup\) %r\" -s \"NQRustBackup: %t %e of %c %l\" %r"
     Operator Command = "/usr/sbin/nqrustbackup_smtp -h mail.example.com -f \"\(NQRustBackup\) %r\" -s \"NQRustBackup: Intervention needed for %j\" %r"
     Mail On Error = backupoperator@example.com = all, !skipped, !terminate
     Append = "/var/log/nqrustbackup/nqrustbackup.log" = all, !skipped, !terminate
     Operator = backupoperator@example.com = mount
     Console = all, !skipped, !saved
   }
