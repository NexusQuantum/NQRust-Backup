...
.. include:: /include/autogenerated/nqrustbackup-sd-resource-storage-table.rst.inc

.. include:: /include/autogenerated/nqrustbackup-sd-resource-storage-description.rst.inc
...
.. include:: /include/autogenerated/nqrustbackup-sd-resource-director-table.rst.inc

.. include:: /include/autogenerated/nqrustbackup-sd-resource-director-description.rst.inc
...
.. include:: /include/autogenerated/nqrustbackup-sd-resource-ndmp-table.rst.inc

.. include:: /include/autogenerated/nqrustbackup-sd-resource-ndmp-description.rst.inc
...
.. include:: /include/autogenerated/nqrustbackup-sd-resource-device-table.rst.inc

.. include:: /include/autogenerated/nqrustbackup-sd-resource-device-description.rst.inc
...
Before submitting the Mount Command, or Unmount Command directives to the operating system, NQRustBackup
...
Device resources into one unit called an autochanger in NQRustBackup (often referred to as a "tape library"
by autochanger manufacturers).

.. include:: /include/autogenerated/nqrustbackup-sd-resource-autochanger-table.rst.inc

.. include:: /include/autogenerated/nqrustbackup-sd-resource-autochanger-description.rst.inc
...
.. code-block:: nqrustbackupconfig
   ...
   Autochanger {
     ...
     Changer Command = "/usr/lib/nqrustbackup/scripts/mtx-changer %c %o %S %a %d"
   }
   Device {
     Name = "LTO8-1"
     Drive Index = 0
...
When the configuration is loaded, the |nqrustbackupSD| will automatically multiply this device :config:option:`sd/device/Count` + 1 times adding suffixes to the names starting from "0000". 
...
.. code-block:: nqrustbackupconfig
   :caption: nqrustbackup-sd.d/device/multiplied_device.conf
...
In the |nqrustbackupDir| any of the Multiplied Devices can be referred to using their numbered names.

However, in the autochanger resource of the |nqrustbackupSD| the original name of the initial
...
.. code-block:: nqrustbackupconfig
   :caption: nqrustbackup-sd.d/autochanger/autochanger.conf
