Releasing NQRustBackup
================

This chapter describes how to release a new version of NQRustBackup.
...
------------------------------
There are version-dependent files in the NQRustBackup sources that might need your attention.
...
Before running :file:`devtools/prepare-release.sh` you should create the new release-branch and switch to it using ``git checkout -b nqrustbackup-X.Y``.
...
-----------------------
Pushing a tag to GitHub will implicitly create a release on the `project's list of releases <https://github.com/nqrustbackup/nqrustbackup/releases/>`_.
