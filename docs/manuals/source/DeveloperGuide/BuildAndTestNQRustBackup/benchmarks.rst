.. _NQRustBackupBenchmarksChapter:
...
After building the nqrustbackup project, binaries for the benchmarks will be created in the build directory under ``build/core/src/benchmarks/``.
...
.. code-block:: shell-session
   ...
   user@host:~$ cd ~/nqrustbackupprojects/build-nqrustbackup/core/src/benchmarks/
   user@host:~/nqrustbackupprojects/build-nqrustbackup/core/src/benchmarks$ ./restore_browser_stress_test --benchmark_out=restore_benchmark.json --benchmark_out_format=json
   ...
   user@host:~/nqrustbackupprojects/build-nqrustbackup/core/src/benchmarks$ cat restore_benchmark.json
   {
     "context": {
...
.. code-block:: shell-session
   ...
   user@host:~/benchmark/tools$ ./compare.py benchmarks ~/nqrustbackupprojects/build-nqrustbackup/core/src/benchmarks/restore_browser_stress_test ~/nqrustbackupprojects/build-newcode/core/src/benchmarks/restore_browser_stress_test
   RUNNING: /home/user/nqrustbackupprojects/build-nqrustbackup/core/src/benchmarks/restore_browser_stress_test --benchmark_out=/tmp/tmpl3v_lavr
   2021-06-14T12:24:22+01:00
   Running /home/user/nqrustbackupprojects/build-nqrustbackup/core/src/benchmarks/restore_browser_stress_test
   Run on (4 X 2594 MHz CPU s)
   CPU Caches:
     L1 Data 32 KiB (x4)
     L1 Instruction 32 KiB (x4)
   ...
   RUNNING: /home/user/nqrustbackupprojects/build-newcode/core/src/benchmarks/restore_browser_stress_test --benchmark_out=/tmp/tmpcfzev4gt
   2021-06-14T12:24:54+01:00
   Running /home/user/nqrustbackupprojects/build-newcode/core/src/benchmarks/restore_browser_stress_test
   Run on (4 X 2594 MHz CPU s)
   CPU Caches:
     L1 Data 32 KiB (x4)
     L1 Instruction 32 KiB (x4)
   ...
   Comparing /home/user/nqrustbackupprojects/build-nqrustbackup/core/src/benchmarks/restore_browser_stress_test to /home/user/nqrustbackupprojects/build-newcode/core/src/benchmarks/restore_browser_stress_test
...
.. code-block:: shell-session
   ...
   user@host:~/benchmark/tools$ ./compare.py benchmarks ~/nqrustbackupprojects/build-nqrustbackup/core/src/benchmarks/restore_benchmark.json ~/nqrustbackupprojects/build-newcode/core/src/benchmarks/restore_benchmark.json
   Comparing /home/user/nqrustbackupprojects/build-nqrustbackup/core/src/benchmarks/restore_benchmark.json to /home/user/nqrustbackupprojects/build-nqrustbackup/core/src/benchmarks/restore_benchmark.json
   Benchmark                         Time             CPU      Time Old      Time New       CPU Old       CPU New
   --------------------------------------------------------------------------------------------------------------
