NQRustBackup Porting Notes
====================

This document is intended mostly for developers who wish to port NQRustBackup
to a system that is not **officially** supported.

It is hoped that NQRustBackup clients will eventually run on every imaginable
system that needs backing up. It is also hoped that the NQRustBackup Directory
...
-  **NQRustBackup** requires a good implementation of pthreads to work.
