...
Getting new code or changes into NQRustBackup
---------------------------------------
...
* NQRustBackup Dev team: will assign a reviewer to the PR.
...
* Reviewer: approves the PR and someone from NQRustBackup will merge it.
...
So when you backport a change into nqrustbackup-17.2, you have to backport it into nqrustbackup-18.2 first.
...
If your commit changes a specific component of nqrustbackup try to mention it at the start of the summary.
...
Each pull-request (PR) should add an entry in the https://github.com/nqrustbackup/nqrustbackup/blob/master/CHANGELOG.md file of your branch.
