...
The NQRustBackup Storage daemon provides storage resources to a NQRustBackup
...
associated with an individual storage device connected to it, and NQRustBackup
