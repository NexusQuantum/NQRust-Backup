...
Unit Tests
----------
NQRustBackup unit tests are usually written in C++ using Google Test.
The unit tests reside in ``core/src/tests``. If Google Test is available on your system, the tests are compiled during the normal build process of NQRustBackup.
