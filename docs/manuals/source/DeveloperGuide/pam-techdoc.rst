...
The name of the service to be registered with the respective PAM module is "nqrustbackup".

The following sequence diagram shows three options how a user can be authorized on a NQRustBackup Director Daemon:
...
In this example the complete connection and authorization sequence of a NQRustBackup Console respective NQRustBackup Webui is shown.

A detailed description on the configuration see this chapter: :ref:`PAMConfigurationChapter`.

.. uml::
  :caption: Console/WebUI connection sequence from NQRustBackup 18.2
