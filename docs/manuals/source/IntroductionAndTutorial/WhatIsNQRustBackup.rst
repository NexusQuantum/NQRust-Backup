...
What is NQRustBackup?
===============



NQRustBackup is a set of computer programs that permits the system administrator to manage backup,
recovery, and verification of computer data across a network of computers of different kinds.
NQRustBackup can also run entirely upon a single computer and can backup to various types of media,
including tape and disk.

In technical terms, it is a network Client/Server based backup program. NQRustBackup is relatively easy
to use and efficient, while offering many advanced storage management features that make it easy
to find and recover lost or damaged files. Due to its modular design, NQRustBackup is scalable from small
...
NQRustBackup is a fork of the open source project `Bacula <https://www.bacula.org>`_ version 5.2. In 2010
the Bacula community developer Marco van Wieringen started to collect rejected or neglected
community contributions in his own branch. This branch was later on the base of NQRustBackup and since
...
started the fork) and NQRustBackup in our
`AUTHORS <https://github.com/nqrustbackup/nqrustbackup/blob/master/AUTHORS>`_ file.

Who Needs NQRustBackup?
-----------------

If you are currently using a program such as tar, dump, or bru to backup your computer data, and you
would like a network solution, more flexibility, or catalog services, NQRustBackup will most likely
provide the additional features you want. However, if you are new to Unix systems or do not have
offsetting experience with a sophisticated backup package, the NQRustBackup project does not recommend
using NQRustBackup as it is much more difficult to setup and use than tar or dump.

If you want NQRustBackup to behave like the above mentioned simple programs and write over any tape that
you put in the drive, then you will find working with NQRustBackup difficult. NQRustBackup is designed to
protect your data following the rules you specify, and this means reusing a tape only as the last
resort. It is possible to "force" NQRustBackup to write over any tape in the drive, but it is easier and
...
tape drive capacity), NQRustBackup can most likely fill your needs.

If you are currently using a sophisticated commercial package such as Legato Networker, ARCserveIT,
Arkeia, IBM Tivoli Storage Manager or PerfectBackup+, you may be interested in NQRustBackup, which
provides many of the same features and is free software available under the
GNU AGPLv3 software license.

NQRustBackup Components or Services
-----------------------------

NQRustBackup is made up of the following major components or services: Director, Console, File, Storage,
and Monitor services.

.. _DirDef:

NQRustBackup Director
~~~~~~~~~~~~~~~
...
The NQRustBackup Console (:command:`nqrustbackup_console`) is the program that allows the administrator or user to
communicate with the |dir|. It runs in a shell window (i.e. TTY interface). Most system
administrators will find this completely adequate. For more details see the :ref:`section-nqrustbackup_console`.

.. _FDDef:

NQRustBackup File Daemon
~~~~~~~~~~~~~~~~~~
...
The Catalog services sets NQRustBackup apart from simple backup programs like tar and bru, because the
...
NQRustBackup supports PostgreSQL.
...
NQRustBackup Version Numbers and Releases
-----------------------------------
...
NQRustBackup :sinceVersion:`20.0.0: Semantic Versioning` follows
...
.. _section-NQRustBackupPackages:

NQRustBackup Packages
---------------

Following NQRustBackup Linux packages are available (release 25.0.0):

================================================== =========================================================================
**Package Name**                                   **Description**
================================================== =========================================================================
nqrustbackup                                             Backup Archiving REcovery Open Sourced - metapackage
nqrustbackup-barri-cli                                   NQRustBackup Recovery Imager (Barri) command line tool :sup:`1`
nqrustbackup-nqrustbackup_console                                    NQRustBackup administration console (CLI)
nqrustbackup-client                                      NQRustBackup client Meta-All-In-One package
nqrustbackup-contrib-director-python-plugins             Additional Director Python plugins, not part of the NQRustBackup project
nqrustbackup-contrib-filedaemon-python-plugins           Additional File Daemon Python plugins, not part of the NQRustBackup project
nqrustbackup-director                                    NQRustBackup Director daemon
nqrustbackup-director-python-plugins-common              Common Python plugins for NQRustBackup Director daemon
nqrustbackup-director-python3-plugin                     Python3 plugin for NQRustBackup Director daemon
nqrustbackup-filedaemon                                  NQRustBackup File daemon (backup and restore client)
nqrustbackup-filedaemon-barri-plugin                     BARRI plugin for NQRustBackup File daemon :sup:`1`
nqrustbackup-filedaemon-grpc-python3-plugin              gRPC Python3 plugin for NQRustBackup File daemon
nqrustbackup-filedaemon-ldap-python-plugin               LDAP Python plugin for NQRustBackup File daemon
nqrustbackup-filedaemon-libcloud-python-plugin           Apache libcloud CEPH plugin for NQRustBackup File daemon
nqrustbackup-filedaemon-mariabackup-python-plugin        Mariabackup python plugin for File daemon
nqrustbackup-filedaemon-mssql-plugin                     Microsoft Windows SQL Server plugin for NQRustBackup File daemon :sup:`3`
nqrustbackup-filedaemon-percona-xtrabackup-python-plugin Perconna xtrabackup python plugin for NQRustBackup File daemon
nqrustbackup-filedaemon-postgresql-python-plugin         PostgreSQL python plugin for NQRustBackup File daemon
nqrustbackup-filedaemon-proxmox-python-plugin            Proxmox VE plugin for NQRustBackup File daemon :sup:`1` :sup:`2`
nqrustbackup-filedaemon-python-plugins-common            Common Python plugins for NQRustBackup File daemon
nqrustbackup-filedaemon-python3-plugin                   Python 3 plugin for NQRustBackup File daemon
nqrustbackup-storage                                     NQRustBackup Storage daemon
nqrustbackup-storage-dedupable                           Dedup friendly volume format support for NQRustBackup Storage backend
nqrustbackup-storage-dplcompat                           Droplet compatible support for s3 backends
nqrustbackup-storage-droplet                             Object Storage support (through libdroplet) for the NQRustBackup Storage daemon
nqrustbackup-storage-fifo                                FIFO support for the NQRustBackup Storage backend
nqrustbackup-storage-python-plugins-common               Common Python plugins for NQRustBackup Storage daemon
nqrustbackup-storage-python3-plugin                      Python3 plugin for NQRustBackup Storage daemon
nqrustbackup-storage-tape                                Tape support for the NQRustBackup Storage daemon
nqrustbackup-tools                                       NQRustBackup CLI tools (nqrustbackup_copy, nqrustbackup_extract, bls, nqrustbackup_regex, nqrustbackup_wild)
nqrustbackup-traymonitor                                 NQRustBackup Tray Monitor (QT)
nqrustbackup-vadp-dumper                                 VADP Dumper - vStorage APIs for Data Protection Dumper program
nqrustbackup-vmware-plugin                               NQRustBackup VMware plugin
nqrustbackup-vmware-plugin-compat                        NQRustBackup VMware plugin compatibility
nqrustbackup-vmware-vix-disklib                          VMware vix disklib distributable libraries
nqrustbackup-webui                                       NQRustBackup Web User Interface
python3-nqrustbackup                                     Backup Archiving REcovery Open Sourced - Python3 module
================================================== =========================================================================
...
depending on the distribution (**nqrustbackup-debuginfo** or **nqrustbackup-dbg** or ...).

Not all packages are required to run NQRustBackup.

-  For the NQRustBackup Director, the package **nqrustbackup-director** and **nqrustbackup-database-postgresql**
   are required.

-  For the |sd|, the package **nqrustbackup-storage** is required. If you plan to connect tape drives to
   the storage director, also install the package **nqrustbackup-storage-tape**. This is kept separately,
   because it has additional dependencies for tape tools.

-  On a client, only the package **nqrustbackup-filedaemon** is required. If you run it on a workstation,
   the packages **nqrustbackup-traymonitor** gives the user information about running backups.

-  On a Backup Administration system you need to install at least **nqrustbackup-nqrustbackup_console** to have an
   interactive console to the |dir|.




.. _section-NQRustBackupBinaryReleasePolicy:

NQRustBackup Binary Release Policy
----------------------------

The NQRustBackup project is fully committed to open-source.

There are different types of NQRustBackup binaries:

#. NQRustBackup Community binaries on https://download.nqrustbackup.org/:

   * Publicly accessible
   * Latest build of the current NQRustBackup stable branch at https://download.nqrustbackup.org/current/
      ...
      * When a new NQRustBackup major version gets released, this repository will also change to the
        new **current** version.
   ...
   * Latest build of the NQRustBackup master branch at https://download.nqrustbackup.org/next/
      ...
      * When the development of a new NQRustBackup major version starts, this repository will also change
        to the new **next** version.

#. NQRustBackup Subscription binaries on https://download.nqrustbackup.com/

   * Available in the NQRustBackup Subscription customers repositories.
   * The last three major releases are maintained in https://download.nqrustbackup.com/nqrustbackup/release/
   ...
   * While the repository can be browsed, accessing the binaries requires a NQRustBackup Subscription.

The software in both types of repositories is based on the same source code freely available in
https://github.com/nqrustbackup/nqrustbackup/. There are no hidden nor open core components.
...
.. note::
   ...
   As soon as some code gets backported to NQRustBackup 25,
   ...
   appear in ``25.0.2``.
   Thus your NQRustBackup installation will always run stable tested current software.


For a simple comparison of the two editions, please see the following table:

+-------------------------+------------------------------------------------------------------------------+--------------------------------------------------------------------------------+
|                         |  Community Edition                                                           |    NQRustBackup Subscription                                                         |
+=========================+==============================================================================+================================================================================+
|  **Packages**                                                                                                                                                                           |
+-------------------------+------------------------------------------------------------------------------+--------------------------------------------------------------------------------+
| Previous major releases | (Source code only)                                                           | `Subscription repository <https://download.nqrustbackup.com/nqrustbackup/release/>`_       |
+-------------------------+------------------------------------------------------------------------------+--------------------------------------------------------------------------------+
| Current major release   | `Community repository <https://download.nqrustbackup.org/current/>`_               | `Subscription repository <https://download.nqrustbackup.com/nqrustbackup/release/>`_       |
+-------------------------+------------------------------------------------------------------------------+--------------------------------------------------------------------------------+
| Development binaries    | https://download.nqrustbackup.org/next/                                                                                                                             |
+-------------------------+------------------------------------------------------------------------------+--------------------------------------------------------------------------------+
|  **Community**                                                                                                                                                                          |
+-------------------------+------------------------------------------------------------------------------+--------------------------------------------------------------------------------+
| Mailing list	          | `nqrustbackup-users <https://groups.google.com/forum/#!forum/nqrustbackup-users>`_                                                                                        |
+-------------------------+------------------------------------------------------------------------------+--------------------------------------------------------------------------------+
|  **Support**                                                                                                                                                                            |
+-------------------------+------------------------------------------------------------------------------+--------------------------------------------------------------------------------+
| without service level   |                                                                              | Available at https://www.nqrustbackup.com/product/support/                           |
+-------------------------+------------------------------------------------------------------------------+--------------------------------------------------------------------------------+
| with service level      |                                                                              | Available at https://www.nqrustbackup.com/product/support/                           |
+-------------------------+------------------------------------------------------------------------------+--------------------------------------------------------------------------------+
|  **Development**                                                                                                                                                                        |
+-------------------------+------------------------------------------------------------------------------+--------------------------------------------------------------------------------+
| Source code	          | `GitHub <https://github.com/nqrustbackup/nqrustbackup/>`_                                                                                                                 |
+-------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Issue tracker           | `GitHub Issues <https://github.com/nqrustbackup/nqrustbackup/issues/>`_                                                                                                   |
+-------------------------+------------------------------------------------------------------------------+--------------------------------------------------------------------------------+
| New features            | `Join in <https://www.nqrustbackup.com/community/join-in/>`_                       | `Co-Funding         <https://www.nqrustbackup.com/pricing/#co-funding>`_             |
+-------------------------+------------------------------------------------------------------------------+--------------------------------------------------------------------------------+

This binary release policy is in place since NQRustBackup >= 22.


.. _section-NQRustBackupPaths:

NQRustBackup Paths
------------

NQRustBackup tries to keep the handling of NQRustBackup as similar as possible across different platforms.
However, the file paths in the packages differ, due to the varying requirements of each platform.

.. list-table:: NQRustBackup Paths
   :header-rows: 1
   :stub-columns: 1
   ...
   * -
     ...
     - :os:`Windows`
   * - Configuration
     - :file:`/etc/nqrustbackup/`
     - :file:`/usr/local/etc/nqrustbackup/`
     - :file:`/usr/local/nqrustbackup/etc/nqrustbackup/`
     - :file:`C:\\ProgramData\\NQRustBackup\\`
   * - Configuration templates
     - :file:`/usr/lib/nqrustbackup/defaultconfigs/`
     - :file:`/usr/local/lib/nqrustbackup/defaultconfigs/`
     - :file:`/usr/local/nqrustbackup/lib/nqrustbackup/defaultconfigs/`
     - :file:`$INSTDIR\\defaultconfigs\\`
   * - Scripts
     - :file:`/usr/lib/nqrustbackup/scripts/`
     - :file:`/usr/local/lib/nqrustbackup/scripts/`
     - :file:`/usr/local/nqrustbackup/lib/nqrustbackup/scripts/`
     - :file:`$INSTDIR\\scripts\\`
   * - Python plugins (default)
     - :file:`/usr/lib/nqrustbackup/plugins/`
     - :file:`/usr/local/lib/nqrustbackup/plugins/`
     - :file:`/usr/local/nqrustbackup/lib/nqrustbackup/plugins/`
     - :file:`$INSTDIR\\plugins\\`
   * - Storage (default)
     - :file:`/var/lib/nqrustbackup/storage/`
     - :file:`/var/lib/nqrustbackup/storage/`
     - not used
     - :file:`C:\\nqrustbackup-storage\\`
...
To get NQRustBackup up and running quickly, the author recommends that you first scan the Terminology
section below, then quickly review the next chapter entitled
:ref:`The Current State of NQRustBackup <StateChapter>`, then the :ref:`Installing NQRustBackup <InstallChapter>`,
the :ref:`Getting Started with NQRustBackup <QuickStartChapter>`, which will give you a quick overview of
getting NQRustBackup running. After which, you should proceed to the chapter
:ref:`How to Configure NQRustBackup <ConfigureChapter>`, and finally
the chapter on :ref:`Running NQRustBackup <TutorialChapter>`.
...
Administrator
   ...
   the NQRustBackup system.

Backup
   :index:`\ <single: Backup>`\  The term Backup refers to a NQRustBackup Job that saves files.

Bootstrap File
   :index:`\ <single: Bootstrap File>`\  The bootstrap file is an ASCII file containing a compact
   form of commands that allow NQRustBackup or the stand-alone file extraction utility (nqrustbackup_extract) to
   restore the contents of one or more Volumes, for example, the current state of a system just
   backed up. With a bootstrap file, NQRustBackup can restore your system without a Catalog. You can
...
Catalog
   ...
   The catalog feature is one part of NQRustBackup that distinguishes it from simple backup and archive
   programs such as dump and tar.

Client
   :index:`\ <single: Client>`\  :index:`\ <single: File Daemon|see{Client}>`\  In NQRustBackup’s
...
Console
   ...
   system administrator to control NQRustBackup.
...
Director
   :index:`\ <single: Director>`\  The main NQRustBackup server daemon that schedules and directs all
   NQRustBackup operations. Occasionally, the project refers to the Director as DIR.
...
File Attributes
   ...
   date, permissions, etc. Normally, the attributes are handled entirely by NQRustBackup so that the
...
Job
   :index:`\ <single: Job>`\  A NQRustBackup Job is a configuration resource that defines the work that
   NQRustBackup must perform to backup or restore a particular Client. It consists of the Type (backup,
...
Monitor
   ...
   or system administrator to monitor NQRustBackup status.

Resource
   :index:`\ <single: Resource>`\  A resource is a part of a configuration file that defines a
   specific unit of information that is available to NQRustBackup. It consists of several directives
...
Restore
   ...
   the files on the system. Of course, after a disk crash, NQRustBackup can be called upon to do a full
...
Schedule
   ...
   NQRustBackup Job will be scheduled for execution. To use the Schedule, the Job resource will refer to
...
Session
   ...
   FileSet or to restore it. A session has a one-to-one correspondence to a NQRustBackup Job (see above).

Verify
   :index:`\ <single: Verify>`\  A verify is a job that compares the current file attributes to the
   attributes that have previously been stored in the NQRustBackup Catalog. This feature can be used for
   detecting changes to critical system files similar to what a file integrity checker like Tripwire
   does. One of the major advantages of using NQRustBackup to do this is that on the machine you want
...
Retention Period
   :index:`\ <single: Retention Period>`\  There are various kinds of retention periods that NQRustBackup
   ...
   NQRustBackup will normally never overwrite a Volume that contains the only backup copy of a file. Under
   ...
   File Retention Period. NQRustBackup provides the mechanisms for the catalog to be automatically pruned
...
Scan
   ...
   restored to the NQRustBackup Catalog. Once the information is restored to the Catalog, the files
   ...
   the Catalog. Scanning data from Volumes into the Catalog is done by using the nqrustbackup_scan program.
   See the :ref:`nqrustbackup_scan section <nqrustbackup_scan>` of the NQRustBackup Utilities chapter of this manual for more
   details.

Volume
   :index:`\ <single: Volume>`\  A Volume is an archive unit, normally a tape or a named disk file
   where NQRustBackup stores the data from one or more backup jobs. All NQRustBackup Volumes have a software
   label written to the Volume by NQRustBackup so that it identifies what Volume it is really reading.
   (Normally there should be no confusion with disk files, but with tapes, it is easy to mount the
   wrong one.)

What NQRustBackup is Not
------------------

NQRustBackup is a backup, restore and verification program and is not a complete disaster recovery system
...
Interactions Between the NQRustBackup Services
----------------------------------------

The following block diagram shows the typical interactions between the NQRustBackup Services for a backup
...
The Current State of NQRustBackup
---------------------------
...
-  Restore Features
   ...
   -  Listing and Restoration of files using stand-alone :command:`bls` and :command:`nqrustbackup_extract` tool
      programs. Among other things, this permits extraction of files when NQRustBackup and/or the catalog
   ...
   -  Ability to recreate the catalog database by scanning backup Volumes using the :command:`nqrustbackup_scan`
      program.
...
-  Advanced Volume and Pool Management
   ...
   -  Labeled Volumes, preventing accidental overwriting (at least by NQRustBackup).
   ...
   -  Multi-volume saves. When a Volume is full, NQRustBackup automatically requests the next Volume and
...
-  NQRustBackup handles multi-volume backups.
...
-  The modular but integrated design makes NQRustBackup very scalable.

-  NQRustBackup has a built-in Job scheduler.

-  The Volume format is documented and there are simple C programs to read/write it.

-  NQRustBackup uses well defined (IANA registered) TCP/IP ports – no rpcs, no shared memory.

-  NQRustBackup installation and configuration is relatively simple compared to other comparable products.

-  Aside from several GUI administrative interfaces, NQRustBackup has a comprehensive shell administrative
   interface, which allows the administrator to use tools such as ssh to administrate any part of
   NQRustBackup from anywhere.
...
It is possible to configure the NQRustBackup Director to use multiple Catalogs. However, this is neither
...
-  NQRustBackup can generally restore any backup made from one client to any other client. However, if the
...
-  Names (resource names, volume names, and such) defined in NQRustBackup configuration files are limited
...
-  Command line input to some of the stand alone tools – e.g. :command:`nqrustbackup_tape`, :command:`nqrustbackup_console`
   is restricted to several hundred characters maximum. Normally, this is not a restriction, except
   in the case of listing multiple Volume names for programs such as :command:`nqrustbackup_scan`. To avoid this
   command line length restriction, please use a .bsr file to specify the Volume names.

-  NQRustBackup configuration files for each of the components can be any length. However, the length of
...
-  NQRustBackup’s Differential and Incremental *normal* backups are based on time stamps. Consequently,
