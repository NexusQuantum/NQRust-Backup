...
This chapter will guide you through running NQRustBackup. To do so, we assume you have installed
NQRustBackup. However, we assume that you have not modified the configuration. The examples in
this chapter use the default configuration files and will write the volumes to disk in
your :file:`/var/lib/nqrustbackup/storage/` directory.

The general flow of running NQRustBackup is:
...
Installing NQRustBackup
-----------------

For installing NQRustBackup, follow the instructions from the :ref:`InstallChapter` chapter.
...
.. code-block:: shell-session
   ...
   systemctl start nqrustbackup-dir nqrustbackup-sd nqrustbackup-fd
...
.. code-block:: shell-session
   ...
   systemctl enable --now nqrustbackup-dir nqrustbackup-sd nqrustbackup-fd
...
.. code-block:: shell-session
   ...
   systemctl start nqrustbackup-director nqrustbackup-storage nqrustbackup-filedaemon
...
.. code-block:: shell-session
   ...
   systemctl enable --now nqrustbackup-director nqrustbackup-storage nqrustbackup-filedaemon



.. _section-TutorialNQRustBackupConsole:

Using the Director to Query and Start Jobs
------------------------------------------

To communicate with the |dir| and to query the state of NQRustBackup or run jobs, the :command:`nqrustbackup_console`
...
only the :command:`nqrustbackup_console` program.

The :command:`nqrustbackup_console` runs the NQRustBackup Console program, which connects to the |dir|.
Since NQRustBackup is a network program, you can run the Console program anywhere on your
...
.. code-block:: shell-session
   :caption: nqrustbackup_console

   root@host:~# nqrustbackup_console
      Connecting to Director localhost:9101
       Encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3
      1000 OK: nqrustbackup-dir Version: 23.0.0 (23 September 2023)
...
.. code-block:: nqrustbackup_console
   ...
   *<input>help</input>
     ...
     exit               Terminate NQRustBackupConsole session
     ...
     quit               Terminate NQRustBackupConsole session
     query              Query catalog
...
Details of the console program’s commands are explained in the :ref:`section-nqrustbackup_console` chapter.
...
-  Installed NQRustBackup

-  Prepared the database for NQRustBackup

-  Started NQRustBackup Director, Storage Daemon and File Daemon

-  Invoked the Console program with :command:`nqrustbackup_console`
...
.. code-block:: nqrustbackup_console
   ...
   *<input>show filesets</input>
   ...
   FileSet {
     Name = "Catalog"
     Description = "Backup the catalog dump and NQRustBackup configuration files."
     Include {
       Options {
         Signature = "XXH128"
         HardLinks = No
       ...
       File = "/var/lib/nqrustbackup/nqrustbackup.sql"
...
The FileSet :config:option:`dir/fileset = Catalog`\  is used for backing up NQRustBackup’s
...
Now is the time to run your first backup job. We are going to backup your NQRustBackup source
directory to a File Volume in your :file:`/var/lib/nqrustbackup/storage/` directory just to
...
.. code-block:: nqrustbackup_console
   ...
   *<input>status dir</input>
   nqrustbackup-dir Version: 23.0.0 (23 September 2023) GNU/Linux
   Daemon started 2023-09-23T08:59:05+0000. Jobs: run=0, running=0 db:postgresql,

   Scheduled Jobs:
   Level          Type     Pri  Scheduled          Name               Volume
   ===================================================================================
   Incremental    Backup    10  2023-09-23T21:00:00+0000 backup-nqrustbackup-fd   *unknown*
...
.. code-block:: nqrustbackup_console
   ...
   *<input>status client</input>
   Automatically selected Client: nqrustbackup-fd
   Connecting to Client nqrustbackup-fd at localhost:9102
   ...
   nqrustbackup-fd Version: 23.0.0 (23 September 2023) GNU/Linux
   Daemon started 2023-09-23T08:59:01+0000. Jobs: run=0 running=0, NQRustBackup subscription binary
    Sizeof: boffset_t=8 size_t=8 debug=0 trace=0 bwlimit=0kB/s

   Running Jobs:
   nqrustbackup-dir (director) connected at: 2023-09-23T09:47:03+0000
   No Jobs running.
   ====
...
In this case, the client is named :config:option:`Dir/Client = nqrustbackup-fd`\  your name
might be different, but the line beginning with :file:`nqrustbackup-fd Version` is printed by
...
.. code-block:: nqrustbackup_console
   ...
   *<input>status storage</input>
   ...
   Connecting to Storage daemon File at nqrustbackup-sd:9103
    Encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3

   nqrustbackup-sd Version: 23.0.0 (23 September 2023) GNU/Linux
   Daemon started 2023-09-23T08:59:03+0000. Jobs: run=0, running=0, NQRustBackup subscription binary
...
and that it will use device :file:`/var/lib/nqrustbackup/storage`, which is not currently open.
...
.. code-block:: nqrustbackup_console
   ...
   1: backup-nqrustbackup-fd
   2: BackupCatalog
   3: RestoreFiles
   Select Job resource (1-3):


Here, NQRustBackup has listed the three different Jobs that you can run, and you should choose
...
.. code-block:: nqrustbackup_console
   ...
   *<input>messages</input>
   2023-09-23T09:50:04+0000 nqrustbackup-dir JobId 1: No prior Full backup Job record found.
   2023-09-23T09:50:04+0000 nqrustbackup-dir JobId 1: No prior or suitable Full backup found in catalog. Doing FULL backup.
   2023-09-23T09:50:06+0000 nqrustbackup-dir JobId 1: Start Backup JobId 1, Job=backup-nqrustbackup-fd.2023-09-23T09.50.04_03
   2023-09-23T09:50:06+0000 nqrustbackup-dir JobId 1: Connected Storage daemon at localhost:9103, encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3
   2023-09-23T09:50:06+0000 nqrustbackup-dir JobId 1:  Encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3
   2023-09-23T09:50:06+0000 nqrustbackup-dir JobId 1: Connected Client: nqrustbackup-fd at localhost:9102, encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3
   2023-09-23T09:50:06+0000 nqrustbackup-dir JobId 1:  Handshake: Immediate TLS
   2023-09-23T09:50:06+0000 nqrustbackup-dir JobId 1:  Encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3
   2023-09-23T09:50:06+0000 nqrustbackup-dir JobId 1: Created new Volume "Full-0001" in catalog.
   2023-09-23T09:50:06+0000 nqrustbackup-dir JobId 1: Using Device "FileStorage" to write.
   2023-09-23T09:50:06+0000 nqrustbackup-fd  JobId 1: Connected Storage daemon at localhost:9103, encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3
   2023-09-23T09:50:06+0000 nqrustbackup-fd  JobId 1:  Encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3
   2023-09-23T09:50:06+0000 nqrustbackup-fd  JobId 1: Extended attribute support is enabled
   2023-09-23T09:50:06+0000 nqrustbackup-fd  JobId 1: ACL support is enabled
   2023-09-23T09:50:06+0000 nqrustbackup-sd  JobId 1: Labeled new Volume "Full-0001" on device "FileStorage" (/var/lib/nqrustbackup/storage).
   2023-09-23T09:50:06+0000 nqrustbackup-sd  JobId 1: Labeled new Volume "Full-0001" on device "FileStorage" (/var/lib/nqrustbackup/storage)
   2023-09-23T09:50:07+0000 nqrustbackup-sd  JobId 1: Releasing device "FileStorage" (/var/lib/nqrustbackup/storage).
   2023-09-23T09:50:07+0000 nqrustbackup-sd  JobId 1: Elapsed time=00:00:01, Transfer rate=62.68 M Bytes/second
   2023-09-23T09:50:07+0000 nqrustbackup-dir JobId 1: Insert of attributes batch table with 173 entries start
   2023-09-23T09:50:07+0000 nqrustbackup-dir JobId 1: Insert of attributes batch table done
   2023-09-23T09:50:07+0000 nqrustbackup-dir JobId 1: NQRustBackup nqrustbackup-dir 23.0.0 (23Sep23):
     Build OS:               GNU/Linux
     JobId:                  1
     Job:                    backup-nqrustbackup-fd.2023-09-23T09.50.04_03
     Backup Level:           Full (upgraded from Incremental)
     Client:                 "nqrustbackup-fd" 23.0.0 (23Sep23) GNU/Linux
     ...
     NQRustBackup binary info:     NQRustBackup subscription release
...
Instead of typing :bcommand:`messages` multiple times, you can also ask nqrustbackup_console to wait,
...
If you do an :command:`ls -l` of your :file:`/var/lib/nqrustbackup/storage` directory, you will
see that you have the following item


.. code-block:: nqrustbackup_console
   :caption: ls -l /var/lib/nqrustbackup/storage

   total 61240
   -rw-r-----. 1 nqrustbackup nqrustbackup 62706904 Sep 23 09:50 Full-0001
...
As you can see, NQRustBackup knows what client you have, and since there was only one, it
...
Then NQRustBackup produced a listing containing all the jobs that form the current backup,
in this case, there is only one, and the Storage daemon was also automatically chosen.
NQRustBackup then took all the files that were in Job number 1 and entered them into a directory
...
.. code-block:: nqrustbackup_console
   ...
   Bootstrap records written to /var/lib/nqrustbackup/nqrustbackup-dir.restore.2.bsr
   ...
   Replace:         Always
   FileSet:         LinuxAll
   Backup Client:   nqrustbackup-fd
   Restore Client:  nqrustbackup-fd
   Format:          Native
   Storage:         File
...
If you answer :strong:`yes` your files will be restored to :file:`/tmp/nqrustbackup-restores`.
...
.. code-block:: nqrustbackup_console
   ...
   2023-09-23T09:57:34+0000 nqrustbackup-dir JobId 3: Start Restore Job RestoreFiles.2023-09-23T09.57.32_06
   2023-09-23T09:57:34+0000 nqrustbackup-dir JobId 3: Connected Storage daemon at localhost:9103, encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3
   2023-09-23T09:57:34+0000 nqrustbackup-dir JobId 3:  Encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3
   2023-09-23T09:57:35+0000 nqrustbackup-dir JobId 3: Using Device "FileStorage" to read.
   2023-09-23T09:57:35+0000 nqrustbackup-dir JobId 3: Connected Client: nqrustbackup-fd at localhost:9102, encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3
   2023-09-23T09:57:35+0000 nqrustbackup-dir JobId 3:  Handshake: Immediate TLS
   2023-09-23T09:57:35+0000 nqrustbackup-dir JobId 3:  Encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3
   2023-09-23T09:57:37+0000 nqrustbackup-fd  JobId 3: Connected Storage daemon at localhost:9103, encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3
   2023-09-23T09:57:37+0000 nqrustbackup-fd  JobId 3:  Encryption: TLS_CHACHA20_POLY1305_SHA256 TLSv1.3
   2023-09-23T09:57:37+0000 nqrustbackup-sd  JobId 3: Ready to read from volume "Full-0001" on device "FileStorage" (/var/lib/nqrustbackup/storage).
   2023-09-23T09:57:37+0000 nqrustbackup-sd  JobId 3: Forward spacing Volume "Full-0001" to file:block 0:217.
   2023-09-23T09:57:37+0000 nqrustbackup-sd  JobId 3: Releasing device "FileStorage" (/var/lib/nqrustbackup/storage).
   2023-09-23T09:57:37+0000 nqrustbackup-dir JobId 4: NQRustBackup nqrustbackup-dir 23.0.0 (23Sep23):
     Build OS:               GNU/Linux
     JobId:                  4
     Job:                    RestoreFiles.2023-09-23T09.57.32_06
     Restore Client:         "nqrustbackup-fd" 23.0.0 (23Sep23) GNU/Linux
...
After exiting the Console program, you can examine the files in :file:`/tmp/nqrustbackup-restores`,
...
.. code-block:: shell-session
   ...
   root@host:~# rm -rf /tmp/nqrustbackup-restore
...
See :ref:`InstallChapter` about how to add the NQRustBackup repository. The only part you need
installed on the other machine is the :strong:`nqrustbackup-filedaemon`.

Director: configure client
~~~~~~~~~~~~~~~~~~~~~~~~~~

NQRustBackup :sinceVersion:`16.2.4: configure add` offers the :ref:`configure add command <section-bcommandConfigure>` to add resources to the |dir|.

Start the :command:`nqrustbackup_console` and use the :bcommand:`configure add client` command.
...
.. code-block:: nqrustbackup_console
   ...
   *<input>configure add client name=client2-fd address=192.168.0.2 password=secret</input>
   Created resource config file "/etc/nqrustbackup/nqrustbackup-dir.d/client/client2-fd.conf":
   Client {
     Name = client2-fd
     Address = 192.168.0.2
     Password = secret
...
-
   ...
   :file:`/etc/nqrustbackup/nqrustbackup-dir.d/client/client2-fd.conf`

-  :file:`/etc/nqrustbackup/nqrustbackup-dir-export/client/client2-fd/nqrustbackup-fd.d/director/nqrustbackup-dir.conf` (assuming your director resource is named :strong:`nqrustbackup-dir`)

The :file:`/etc/nqrustbackup/nqrustbackup-dir-export/client/client2-fd/nqrustbackup-fd.d/director/nqrustbackup-dir.conf` is the required resource needed on the |fd|. You can copy it to the destination:

.. code-block:: shell-session
   :caption: Copy the nqrustbackup-fd director resource to the new client

   scp /etc/nqrustbackup/nqrustbackup-dir-export/client/client2-fd/nqrustbackup-fd.d/director/nqrustbackup-dir.conf root@client2.example.com:/etc/nqrustbackup/nqrustbackup-fd.d/director/
...
.. code-block:: nqrustbackupconfig
   :caption: nqrustbackup-dir.d/client/client2-fd.conf
...
The package :strong:`nqrustbackup-filedaemon` :sinceVersion:`16.2.4: Client resource files`
brings several configuration files:

-

   :file:`/etc/nqrustbackup/nqrustbackup-fd.d/client/myself.conf`

-

   :file:`/etc/nqrustbackup/nqrustbackup-fd.d/director/nqrustbackup-dir.conf`

-

   :file:`/etc/nqrustbackup/nqrustbackup-fd.d/director/nqrustbackup-mon.conf`

-

   :file:`/etc/nqrustbackup/nqrustbackup-fd.d/messages/Standard.conf`
...
:file:`director/nqrustbackup-dir.conf`
   gives the |dir| :strong:`nqrustbackup-dir` full access to this |fd|. During installation, the
   :config:option:`fd/director/Password`\ is set to a random default. Adapt the name and/or
   the password to your |dir|. (The name :strong:`nqrustbackup-dir` is the default |dir| name since
   NQRustBackup :sinceVersion:`16.2.4: nqrustbackup-dir is the default |dir| name`.)

:file:`director/nqrustbackup-mon.conf`
   gives the |dir| :strong:`nqrustbackup-mon` restricted access to this |fd|. During installation,
   the :config:option:`fd/director/Password`\ is set to a random value. This resource is
   intended to be used by the local :strong:`nqrustbackup-tray-monitor`.

:file:`messages/Standard.conf`
   defines, how messages should be handled. The default sends all relevant messages to the |dir|.

If your |dir| is named :strong:`nqrustbackup-dir`, the :file:`/etc/nqrustbackup/nqrustbackup-fd.d/director/nqrustbackup-dir.conf`
...
for a |dir| with name :strong:`nqrustbackup-dir` and password :strong:`secret` (stored in MD5 format).

.. code-block:: shell-session
   :caption: restart nqrustbackup-fd

   service nqrustbackup-fd restart
...
can create it also manually. If your |dir| is also named :strong:`nqrustbackup-dir`, modify or
create the file :file:`/etc/nqrustbackup/nqrustbackup-fd.d/director/nqrustbackup-dir.conf`:

.. code-block:: nqrustbackupconfig
   :caption: nqrustbackup-fd.d/director/nqrustbackup-dir.conf

   Director {
     Name = "nqrustbackup-dir"   # Name of your NQRustBackup Director
     Password = "secret"   # Password (cleartext or MD5) must be identical
                           # to the password of your client resource in the Director
                           # (nqrustbackup-dir.d/client/client2-fd.conf)
   }

See the relation between resource names and password of the different NQRustBackup components
...
.. code-block:: shell-session
   :caption: show how nqrustbackup-fd would read the current configuration files

   nqrustbackup-fd --export-config
...
.. code-block:: nqrustbackup_console
   ...
   *<input>configure add job name=client2-job client=client2-fd jobdefs=DefaultJob</input>
   Created resource config file "/etc/nqrustbackup/nqrustbackup-dir.d/job/client2-job.conf":
   Job {
     Name = client2-job
     Client = client2-fd
     JobDefs = DefaultJob
...
When you start the NQRustBackup daemons, the Storage daemon attempts to open all defined storage
...
When you run a backup job, one of the things that NQRustBackup must know is what Volumes to use.
Instead of specifying a Volume (tape) directly, you specify which Pool of Volumes you want
NQRustBackup to consult when it wants a Volume for writing backups. NQRustBackup will select the first
available Volume from the Pool that is appropriate for the :config:option:`dir/job/Storage`\
you have specified for the Job being run. When a volume has filled up with data, NQRustBackup
will change its :strong:`VolStatus` from :strong:`Append` to :strong:`Full`, and then
NQRustBackup will use the next volume and so on. If no appendable Volume exists in the Pool,
the Director will attempt to recycle an old Volume. For details, please read the
:ref:`RecyclingChapter` chapter.

If there are still no appendable Volumes available, NQRustBackup will send a message requesting
the operator to create an appropriate Volume.

NQRustBackup keeps track of the Pool name, the volumes contained in the Pool, and a number of
attributes of each of those Volumes.

When NQRustBackup starts, it ensures that all Pool resource definitions have been recorded in
