# NQRustBackup Architectural Decision Records

## Introduction
The NQRustBackup project uses MADR (Markdown Architectural Decision Records) to record significant decisions made in the project.
...
All official NQRustBackup ADRs are in the directory `docs/adr` inside the project's Git repository on the default branch.
## Workflows
### Creating a new ADR
