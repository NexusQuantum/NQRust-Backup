...
if(NOT Readline_FOUND)
  ...
  if(${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
    ...
    if(WIN32)
      find_file(
        Readline_RUNTIME_LIBRARY
        NAMES libreadline8.dll libreadline.dll readline.dll
        HINTS ${Readline_ROOT_DIR}/bin
      )
    endif()
  endif()
    ...
    if(WIN32)
      set_target_properties(
        ...
        PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${Readline_INCLUDE_DIR}"
                   IMPORTED_IMPLIB "${Readline_LIBRARY}"
                   IMPORTED_LOCATION "${Readline_RUNTIME_LIBRARY}"
      )
    else()
      set_target_properties(
        Readline::Readline
