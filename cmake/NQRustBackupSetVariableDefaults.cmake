...
#
#   Copyright (C) 2017-2025 NQRustBackup GmbH & Co. KG
#
...
if(MSVC)
  ...
  set(backenddir
      "${libdir}/backends"
      CACHE STRING "directory for NQRust Backup backends"
  )
  set(plugindir
      "${libdir}/plugins"
      CACHE STRING "directory for NQRust Backup plugins"
  )
  set(scriptdir
      "C:/ProgramData/${CMAKE_PROJECT_NAME}/scripts"
      CACHE STRING "directory for NQRust Backup helper scripts"
  )
  set(sysconfdir
      "C:/ProgramData"
  ...
  set(confdir
      ...
      CACHE STRING "NQRust Backup configuration directory"
  )
  set(configtemplatedir
      "${confdir}"
      CACHE STRING "directory for NQRust Backup configuration templates (optional)"
  )
  set(includedir
  ...
  set(workingdir
      ...
      CACHE STRING "NQRust Backup working directory"
  )
  set(working_dir "${workingdir}")
  set(archivedir
      "C:/nqrustbackup-storage"
      CACHE STRING "NQRust Backup archive directory"
  )
  set(logdir
...
set(PYTHON_MODULE_PATH
    "${plugindir}"
    CACHE STRING "Default path for NQRust Backup Python modules"
)

# db_name
set(db_name
    "nqrustbackup"
    CACHE STRING "NQRust Backup database name"
)
...
set(db_user
    "nqrustbackup"
    CACHE STRING "NQRust Backup database username"
)
...
set(db_password
    ""
    CACHE STRING "NQRust Backup database password"
)
...
set(dir-user
    ""
    CACHE STRING "NQRust Backup Director user"
)
...
set(dir-group
    ""
    CACHE STRING "NQRust Backup Director group"
)
...
set(sd-user
    ""
    CACHE STRING "NQRust Backup Storage Daemon user"
)
set(sd_user ${sd-user})
...
set(sd-group
    ""
    CACHE STRING "NQRust Backup Storage Daemon group"
)
...
set(fd-user
    ""
    CACHE STRING "NQRust Backup File Daemon user"
)
set(fd_user ${fd-user})
...
set(fd-group
    ""
    CACHE STRING "NQRust Backup File Daemon group"
)
...
set(dir-password
    ""
    CACHE STRING "NQRust Backup Director password"
)
...
set(sd-password
    ""
    CACHE STRING "NQRust Backup Storage Daemon password"
)
...
set(fd-password
    ""
    CACHE STRING "NQRust Backup File Daemon password"
)
...
set(mon-dir-password
    ""
    CACHE STRING "NQRust Backup Director monitor password"
)
...
set(mon-fd-password
    ""
    CACHE STRING "NQRust Backup File Daemon monitor password"
)
...
set(mon-sd-password
    ""
    CACHE STRING "NQRust Backup Storage Daemon monitor password"
)
...
option(traymonitor "Build nqrustbackup-traymonitor" OFF)
...
set(dir_port
    "9101"
    CACHE STRING "NQRustBackup Director TCP listen port"
)
set(fd_port
    "9102"
    CACHE STRING "NQRustBackup File Daemon TCP listen port"
)
set(sd_port
    "9103"
    CACHE STRING "NQRustBackup Storage Daemon TCP listen port"
)
...
# do not destroy nqrustbackup-config-lib.sh
set(DB_NAME "@DB_NAME@")
set(DB_USER "@DB_USER@")
set(DB_PASS "@DB_PASS@")
...
set(PACKAGE_STRING "\"${CMAKE_PROJECT_NAME} ${NQRUSTBACKUP_NUMERIC_VERSION}\"")
set(PACKAGE_VERSION "\"${NQRUSTBACKUP_NUMERIC_VERSION}\"")
