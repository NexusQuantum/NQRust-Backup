 ...
 * @copyright Copyright (C) 2014-2024 NQRustBackup GmbH & Co. KG
...
class NQRustBackupBSock implements NQRustBackupBSockInterface
{
     ...
     * NQRustBackup director can send as part of the data stream.
     *
     * @return string
     */
    ...
    /**
     * Connect to a NQRustBackup Director, authenticate the session and establish TLS if needed.
     *
     * @return boolean
     */
    ...
    /**
     * Login into a NQRustBackup Director e.g. authenticate the console session
     *
     * @return boolean
     */
    private function login()
    {
        ...
        if (isset($this->config['console_name'])) {
            ...
            $DIR_HELLO = "Hello " . $bashed_console_name . " calling version $nqrustbackup_full_version\n";
        } else {
     ...
     *
     * @param $cmd
     * @return array: Result received from the NQRustBackup Director.
     */
    public function call_fullresult_json($cmd)
    {
        // should behave similar to
        // https://github.com/nqrustbackup/nqrustbackup/blob/master/python-nqrustbackup/nqrustbackup/bsock/directorconsolejson.py
     ...
     *
     * @param $cmd
     * @return array: The "result" sub-map of the result received from the NQRustBackup Director.
