 ...
 * @copyright Copyright (c) 2024-2024 NQRustBackup GmbH & Co. KG
...
class Util
{
    ...
    public static function getNearestVersionInfo($nqrustbackup_supported_versions, $version)
    {
        foreach ($nqrustbackup_supported_versions as $version_info) {
