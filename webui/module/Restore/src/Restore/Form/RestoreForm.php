...
class RestoreForm extends Form
{
            ...
            $this->add(
                array(
                    ...
                    'attributes' => array(
                        'class' => 'form-control selectpicker show-tick',
                        'id' => 'mergefilesets',
                        'value' => $_SESSION['nqrustbackup']['merge_filesets'] ? 1 : 0,
                        'disabled' => true
                    )
                )
            );
            ...
            $this->add(
                array(
                    ...
                    'attributes' => array(
                        'class' => 'form-control selectpicker show-tick',
                        'id' => 'mergejobs',
                        'value' => $_SESSION['nqrustbackup']['merge_jobs'] ? 1 : 0,
                        'disabled' => true
                    )
                )
            );
        ...
        $this->add(
            array(
                ...
                'attributes' => array(
                    ...
                    'id' => 'where',
                    'size' => '30',
                    'placeholder' => _('e.g. / or /tmp/nqrust-backup-restores/'),
                    'required' => 'required',
                    'disabled' => (!isset($restore_params['client']))
                )
            )
    ...
    /**
     * Convert an NQRustBackup result array so that it is usable as Form Options array.
     * Here it sets key and value to the "name" field of the NQRustBackup array.
     */
