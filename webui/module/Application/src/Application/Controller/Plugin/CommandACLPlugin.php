...
{
    /**
     * Get a list of invalid nqrustbackup-console commands as an array
     *
     * Compares an array of nqrustbackup-console commands with available commands given by
     ...
     * and stored in $_SESSION['nqrustbackup']['commands'].
     *
     * @param commands
     *
     * @return array
    ...
    public function getInvalidCommands($commands = null)
    {
        if (is_array($commands) && !empty($commands)) {
            ...
            foreach ($commands as $command) {
                if (array_key_exists($command, $_SESSION['nqrustbackup']['commands'])) {
                    if (!$_SESSION['nqrustbackup']['commands'][$command]['permission']) {
