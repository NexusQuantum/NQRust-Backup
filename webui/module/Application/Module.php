...
use NQRustBackup\BSock\NQRustBackupBSock;
...
class Module
{
    public function onBootstrap(MvcEvent $e)
    {
        ...
        $translator->setLocale($_SESSION['nqrustbackup']['locale'] ?? 'en_EN')->setFallbackLocale('en_EN');
        ...
        return array(
            ...
            'Laminas\Loader\StandardAutoloader' => array(
                'namespaces' => array(
                    ...
                    'NQRustBackup' => __DIR__ . '/../../vendor/NQRustBackup/library/NQRustBackup',
                ),
            ),
        );
    }
    ...
    public function initSession($e)
    {
        ...
        $container = new Container('nqrustbackup');
