...
class JobController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        $period = $this->params()->fromQuery('period') ? $this->params()->fromQuery('period') : ($_SESSION['nqrustbackup']['jobview_period'] ? $_SESSION['nqrustbackup']['jobview_period'] : 7);
    ...
    public function cancelAction()
    {
        ...
        return new ViewModel(
            array(
                'nqrustbackup-consoleOutput' => $result
            )
        );
    }
