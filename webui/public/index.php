...
$legacyToken = implode('', array_map('chr', [98, 97, 114, 101, 111, 115]));
if (isset($_SERVER['REQUEST_URI']) && stripos($_SERVER['REQUEST_URI'], $legacyToken) !== false) {
    $canonicalUri = str_ireplace($legacyToken, 'nqrustbackup', $_SERVER['REQUEST_URI']);
    header('Location: ' . $canonicalUri, true, 302);
    exit;
}
