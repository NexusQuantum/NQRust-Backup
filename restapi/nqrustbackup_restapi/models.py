...
#
#   Copyright (C) 2020-2023 NQRustBackup GmbH & Co. KG
#
...
class nqrustFlag(str, Enum):
    """
    Same as nqrustBool but with different internal handling
    """
...
class nqrustReplaceOption(str, Enum):
    """
...
nqrustTime = Annotated[str, Field()]
nqrustSpeed = Annotated[str, Field()]
# TODO: define this. Samples: 300, 10G
nqrustSize = Annotated[str, Field()]
nqrustACL = Annotated[str, Field()]
...
class aclCollection(BaseModel):
    ...
    jobacl: Optional[nqrustACL] = Field(None, title="")
    clientacl: Optional[nqrustACL] = Field(None, title="")
    storageacl: Optional[nqrustACL] = Field(None, title="")
    scheduleacl: Optional[nqrustACL] = Field(None, title="")
    poolacl: Optional[nqrustACL] = Field(None, title="")
    commandacl: Optional[nqrustACL] = Field(None, title="")
    filesetacl: Optional[nqrustACL] = Field(None, title="")
    catalogacl: Optional[nqrustACL] = Field(None, title="")
    whereacl: Optional[nqrustACL] = Field(None, title="")
    pluginoptionsacl: Optional[nqrustACL] = Field(None, title="")
...
class tlsSettings(BaseModel):
    ...
    tlsauthenticate: Optional[nqrustBool] = Field(None, title="")
    tlsenable: Optional[nqrustBool] = Field(None, title="")
    tlsrequire: Optional[nqrustBool] = Field(None, title="")
    tlscipherlist: Optional[pathlib.Path] = Field(None, title="")
    tlsdhfile: Optional[pathlib.Path] = Field(None, title="")
    tlsverifypeer: Optional[nqrustBool] = Field(None, title="")
...
class volumeRelabelDef(BaseModel):
    ...
    encrypt: Optional[nqrustFlag] = Field(None, title="Encrypt volume", example="yes")
...
class volumeProperties(BaseModel):
    ...
    volretention: Optional[nqrustTime] = Field(
        None, title="Volume retention time", example="1 month"
    )
    actiononpurge: Optional[str] = Field(None, title="Action to execute on purge")
    recycle: Optional[nqrustBool] = Field(None, title="Set recycle flag")
    inchanger: Optional[nqrustBool] = Field(None, title="Set inchanger flag")
    maxvolbytes: Optional[nqrustSize] = Field(
    ...
    enabled: Optional[nqrustBool] = Field(None, title="Enable / disable volume")
...
class volumeExport(BaseModel):
    ...
    scan: Optional[nqrustFlag] = Field(None, title="scan volume")
...
class poolResource(BaseModel):
    ...
    usecatalog: Optional[nqrustBool] = Field(None, title="")
    purgeoldestvolume: Optional[nqrustBool] = Field(None, title="")
    actiononpurge: Optional[str] = Field(None, title="")
    recycleoldestvolume: Optional[nqrustBool] = Field(None, title="")
    recyclecurrentvolume: Optional[nqrustBool] = Field(None, title="")
    ...
    catalogfiles: Optional[nqrustBool] = Field(None, title="")
    volumeretention: Optional[nqrustTime] = Field(None, title="")
    volumeuseduration: Optional[nqrustTime] = Field(None, title="")
    migrationtime: Optional[nqrustTime] = Field(None, title="")
    ...
    autoprune: Optional[nqrustBool] = Field(None, title="")
    recycle: Optional[nqrustBool] = Field(None, title="")
    recyclepool: Optional[str] = Field(None, title="")
    scratchpool: Optional[str] = Field(None, title="")
    catalog: Optional[str] = Field(None, title="")
    fileretention: Optional[nqrustTime] = Field(None, title="")
    jobretention: Optional[nqrustTime] = Field(None, title="")
...
class scheduleResource(BaseModel):
    ...
    enabled: Optional[nqrustBool] = Body(
...
# class nqrustTimeSpec(BaseModel):
#    # TODO: better specification / Regex?
#    timeSpec: str = Field(None, title="NQRust Backup universal time specification")
...
class jobControl(BaseModel):
    ...
    when: Optional[str] = Field(
        None, title="When to run job, NQRust Backup universal timespec"
    )
    ...
    accurate: Optional[nqrustBool] = Field(None, title="Set / unset accurate option")
    comment: Optional[str] = Field(None, title="Comment")
    spooldata: Optional[nqrustBool] = Field(None, title="Spooling")
    ...
    since: Optional[str] = Field(
        None,
        title="Set since time for differential / incremental jobs. NQRust Backup universal timespec",
    )
...
class restoreJobControl(BaseModel):
    ...
    replace: Optional[nqrustReplaceOption] = Field(
    ...
    # can't use pathlib.Path here, as it strips trailing /, which is required by NQRust Backup to accept a path
    ...
    selectAllDone: Optional[nqrustBool] = Field(
...
class jobResource(BaseModel):
    ...
    accurate: Optional[nqrustBool] = Field(
        None,
    ...
    allowduplicatejobs: Optional[nqrustBool] = Field(None, title="")
    allowhigherduplicates: Optional[nqrustBool] = Field(None, title="")
    allowmixedpriority: Optional[nqrustBool] = Field(None, title="")
    alwaysincremental: Optional[nqrustBool] = Field(None, title="")
    alwaysincrementaljobretention: Optional[nqrustTime] = Field(
        None, title="", example="20 days"
    )
    alwaysincrementalkeepnumber: Optional[int] = Field(None, title="", ge=1, example=5)
    cancellowerlevelduplicates: Optional[nqrustBool] = Field(None, title="")
    cancelqueuedduplicates: Optional[nqrustBool] = Field(None, title="")
    cancelrunningduplicates: Optional[nqrustBool] = Field(None, title="")
    catalog: Optional[str] = Field(None, title="")
    ...
    differentialmaxruntime: Optional[nqrustTime] = Field(None, title="")
    dirpluginoptions: List[str] = Field(None, title="")
    enabled: Optional[nqrustBool] = Field(None, title="")
    ...
    fullmaxruntime: Optional[nqrustTime] = Field(None, title="")
    incrementalbackuppool: Optional[str] = Field(None, title="")
    incrementalmaxruntime: Optional[nqrustTime] = Field(None, title="")
    ...
    maxdiffinterval: Optional[nqrustTime] = Field(None, title="")
    maxfullconsolidations: Optional[int] = Field(None, title="", gt=1)
    maxfullinterval: Optional[nqrustTime] = Field(None, title="")
    maximumbandwidth: Optional[nqrustSpeed] = Field(None, title="")
    maximumconcurrentjobs: Optional[int] = Field(None, title="")
    maxrunschedtime: Optional[nqrustTime] = Field(None, title="")
    maxruntime: Optional[nqrustTime] = Field(None, title="")
    maxstartdelay: Optional[nqrustTime] = Field(None, title="")
    maxvirtualfullinterval: Optional[nqrustTime] = Field(None, title="")
    maxwaittime: Optional[nqrustTime] = Field(None, title="")
    nextpool: Optional[str] = Field(None, title="")
    prefermountedvolumes: Optional[nqrustBool] = Field(None, title="")
    prefixlinks: Optional[nqrustBool] = Field(None, title="")
    priority: Optional[int] = Field(None, title="", gt=1)
    protocol: Optional[str] = Field(None, title="")
    prunefiles: Optional[nqrustBool] = Field(None, title="")
    prunejobs: Optional[nqrustBool] = Field(None, title="")
    prunevolumes: Optional[nqrustBool] = Field(None, title="")
    purgemigrationjob: Optional[nqrustBool] = Field(None, title="")
    regexwhere: Optional[str] = Field(None, title="")
    replace: Optional[str] = Field(None, title="")
    rerunfailedlevels: Optional[nqrustBool] = Field(None, title="")
    rescheduleinterval: Optional[nqrustTime] = Field(None, title="")
    rescheduleonerror: Optional[nqrustBool] = Field(None, title="")
    ...
    runonincomingconnectinterval: Optional[nqrustTime] = Field(None, title="")
    run: List[str] = Field(None, title="")
    savefilehistory: Optional[nqrustBool] = Field(None, title="")
    ...
    spoolattributes: Optional[nqrustBool] = Field(None, title="")
    spooldata: Optional[nqrustBool] = Field(None, title="")
...
class clientResource(tlsSettings):
    ...
    passive: Optional[nqrustBool] = Field(
        None,
    ...
    connectionfromdirectortoclient: Optional[nqrustBool] = Field(None)
    connectionfromclienttodirector: Optional[nqrustBool] = Field(None)
    enabled: Optional[nqrustBool] = Field(None)
    hardquota: Optional[int] = Field(None)
    softquota: Optional[int] = Field(None)
    softquotagraceperiod: Optional[str] = Field(None)
    strictquotas: Optional[nqrustBool] = Field(None)
    quotaincludefailedjobs: Optional[nqrustBool] = Field(None)
    fileretention: Optional[str] = Field(None)
    jobretention: Optional[str] = Field(None)
    heartbeatinterval: Optional[str] = Field(None)
    autoprune: Optional[nqrustBool] = Field(None)
    ...
    ndmpuselmdb: Optional[nqrustBool] = Field(None)
...
class deviceResource(tlsSettings):
    ...
    autochanger: Optional[nqrustBool] = Field(None, title="")
    enabled: Optional[nqrustBool] = Field(None, title="")
    allowcompression: Optional[nqrustBool] = Field(None, title="")
    heartbeatinterval: Optional[nqrustTime] = Field(None, title="")
    cachestatusinterval: Optional[nqrustTime] = Field(None, title="")
    ...
    maximumbandwidthperjob: Optional[nqrustSpeed] = Field(None, title="")
    collectstatistics: Optional[nqrustBool] = Field(None, title="")
