...
def get_version():
    ...
    try:
        with open(
            os.path.join(base_dir, "nqrustbackup_restapi", "VERSION.txt")
        ) as version_file:
            # read version
...
setup(
    ...
    # data_files=[('etc/nqrustbackup/restapi',['etc/restapi.ini'])],
    url="https://github.com/nqrustbackup/nqrustbackup/",
    # What does your project relate to?
    keywords="nqrustbackup, REST API",
    description="REST API for NQRustBackup console access.",
