...
#
# NscaSender for NQRustBackup python plugins
...
class NQRustBackupDirPluginNscaSender(NQRustBackupDirPluginBaseclass.NQRustBackupDirPluginBaseclass):
    ...
    def parse_plugin_definition(self, context, plugindef):
        ...
        '''
        super(NQRustBackupDirPluginNscaSender, self).parse_plugin_definition(
            context, plugindef)
    ...
    def handle_plugin_event(self, context, event):
        ...
        super(NQRustBackupDirPluginNscaSender, self).handle_plugin_event(context, event)
    ...
    def evaluateJobStatus(self,context):
        ...
        '''
        self.nagiosMessage = "";
        coreMessage = "NQRustBackup job %s on %s with id %d level %s, %d errors, %d jobBytes, %d files terminated with status %s" \
