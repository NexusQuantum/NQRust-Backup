...
In your JobDefs or Job Definition configure the plugin itself:
    ...
    Job {
      Name = "BackupClient1"
      DIR Plugin Options ="python:module_path=/usr/lib64/nqrustbackup/plugins:module_name=nqrustbackup-dir-nsca-sender:monitorHost=your.monitor.server:checkHost=nqrustbackup:checkService=nqrustbackup_job_client1:encryption=1"
      JobDefs = "DefaultJob"
    }
