...
# 02110-1301, USA.
#
# NQRustBackup-dir-local-fileset a simple example for a python NQRustBackup Dir Plugin using
# NQRustBackupDirPluginBaseclass. The plugin argument 'filename' is used to read
...
import NQRustBackupDirPluginNscaSender
...
def load_nqrustbackup_plugin(plugindef):
    ...
    NQRustBackupDirWrapper.nqrustbackup_dir_plugin_object = NQRustBackupDirPluginNscaSender.NQRustBackupDirPluginNscaSender(plugindef)
