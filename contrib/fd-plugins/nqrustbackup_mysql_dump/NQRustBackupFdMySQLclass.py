...
# With additions from Maik Aussendorf, NQRustBackup GmbH & Co. KG 2015
...
class NQRustBackupFdMySQLclass(NQRustBackupFdPluginBaseclass):
    '''
        Plugin for backing up all mysql databases found in a specific mysql server
    '''       
    def __init__(self, plugindef):
        NQRustBackupFdPluginBaseclass.__init__(self, plugindef)
        self.file=None
