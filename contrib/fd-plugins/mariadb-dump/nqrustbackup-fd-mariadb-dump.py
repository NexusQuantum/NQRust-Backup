...
#
"""
nqrustbackup-fd-mariadb-dump is a plugin to dump mariadb database via mariadb-dump command
this is the successor of contrib nqrustbackup_mysql_dump. The plugin creates a pipe internally,
...
@NQRustBackupPlugin
class NQRustBackupFdMariadbDump(NQRustBackupFdPluginBaseclass):  # noqa
    """
    ...
    def __init__(self, plugindef):
        ...
        super(NQRustBackupFdMariadbDump, self).__init__(plugindef)
        nqrustbackupfd.DebugMessage(
            100,
            (
    ...
    def parse_plugin_definition(self, plugindef):
        """
        """
        nqrustbackupfd.DebugMessage(100, "parse_plugin_definition started\n")
        NQRustBackupFdPluginBaseclass.parse_plugin_definition(self, plugindef)
        ...
        nqrustbackupfd.DebugMessage(150, f"mariadbconnect={self.mariadbconnect}\n")
    ...
    def start_backup_file(self, savepkt):
        '''
        This method is called, when NQRustBackup is ready to start backup a file
