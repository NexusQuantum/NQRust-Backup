...
from NQRustBackupFdPluginFileInteract import NQRustBackupFdPluginFileInteract
...
def load_nqrustbackup_plugin(plugindef):
    ...
    NQRustBackupFdWrapper.nqrustbackup_fd_plugin_object = NQRustBackupFdPluginFileInteract(plugindef);
