# NQRustBackup FileDaemon Tasks Plugins

These plugins provide specific application's backup for NQRustBackup FileDaemon.

1. XenServer Host, Pool and VM backup [nqrustbackup-fd-xenserver.py](xenserver/README.md)
2. PostgreSQL Database backup [nqrustbackup-fd-pgsql.py](psql/README.md)
3. MySQL Database backup [nqrustbackup-fd-mysql.py](mysql/README.md)
4. Oracle Database backup [nqrustbackup-fd-oracle.py](oracle/README.md)
...
I start to develop a generic base plugin class *NQRustBackupFdTaskClass.py* with the aim to create a fast and
...
1. Override *NQRustBackupFdTaskClass.py* class.
...
File are restored in the filesystem as regular file as it is implemented in *NQRustBackupFdPluginBaseClass,py*.
