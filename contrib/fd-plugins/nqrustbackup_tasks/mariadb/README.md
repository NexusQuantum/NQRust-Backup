# NQRustBackup FileDaemon mariadb Plugin
...
You need the packages *nqrustbackup-filedaemon-python3-plugin* installed on your client.
    ...
    Name = "client-data"
        Include  {
            ...
            Plugin = "python:"
                     ...
                     "module_name=nqrustbackup_tasks.mariadb"
        }
    }
}
```
...
Please read more about the NQRustBackup Python Plugin Interface here:
https://docs.nqrustbackup.org/TasksAndConcepts/Plugins.html#python-fd-plugin
...
#### user
Username of the system user running the `mariadb` and `mariadb-dump` tools. Default: *root* (as the nqrustbackup-fd normally runs as user *root*)
