# NQRustBackup FileDaemon PostgreSQL Plugin
...
You need the packages *nqrustbackup-filedaemon-python-plugin* installed on your client.

## Installation
1. Make sure you have met the prerequisites.
2. Make the *nqrustbackup_tasks* directory available at the path specified with *module_path*
...
FileSet {
    ...
    Include  {
        ...
        Plugin = "python:"
                 "module_name=nqrustbackup_tasks.pgsql"
    }
}
```
...
Please read more about the NQRustBackup Python Plugin Interface here: https://docs.nqrustbackup.org/TasksAndConcepts/Plugins.html#python-fd-plugin

Example plugin options:
```
    Plugin = "python:"
             "module_path=/usr/lib/nqrustbackup/plugins:"
             "module_name=nqrustbackup_tasks.pgsql:"
...
#### pg_user
Specifies the user that will be used to run the *psql* and *pg_dump* tools.  If this option is not set, the default is *postgres*. If this option is set to the empty string (`pg_user=''`), then the user running *nqrustbackup-fd* is used.  Default: *postgres*
