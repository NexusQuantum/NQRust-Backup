...
import socket
from nqrustbackup_tasks.NQRustBackupFdTaskClass import TaskProcess, NQRustBackupFdTaskClass
...
class NQRustBackupFdXenServerClass(NQRustBackupFdTaskClass):
    ...
    def prepare_tasks(self):
        ...
        if self.config.get_boolean('host_backup', True):
            self.tasks.append(TaskHostBackup(NQRustBackupFdXenServerClass.get_hostname()))
