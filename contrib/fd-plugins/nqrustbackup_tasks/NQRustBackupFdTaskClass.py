...
from nqrustbackupfd import JobMessage, DebugMessage, StatPacket, GetValue, bRCs, bIOPS, bJobMessageType, bFileType, bVariable, bVarType, M_ERROR, M_INFO
...
class TaskProcessFIFO(TaskProcess):
    fifo = None
    fifo_path = '/var/lib/nqrustbackup/task.fifo'
    use_stdout = False
...
class NQRustBackupFdTaskClass(NQRustBackupFdPluginBaseclass):
    debug_level = 100
    plugin_name = 'unknown'

    def __init__(self, plugin_def):
        NQRustBackupFdPluginBaseclass.__init__(self, plugin_def)
        self.config = None
        self.folder = None
        self.job_type = None
        self.task = None
    ...
    def parse_plugin_definition(self, plugin_def):
        NQRustBackupFdPluginBaseclass.parse_plugin_definition(self, plugin_def)
    ...
    def plugin_io(self, iop):
        ...
        return super(NQRustBackupFdTaskClass, self).plugin_io(iop)
