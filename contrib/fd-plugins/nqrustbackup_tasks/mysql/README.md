# NQRustBackup FileDaemon MySQL Plugin
    ...
    Name = "client-data"
        Include  {
            ...
            Plugin = "python:"
                     ...
                     "module_name=nqrustbackup_tasks.mysql"
        }
    }
}
```
...
#### user
Username of the system user running the *mysql* and *mysqldump* tools. Default: *root* (as the nqrustbackup-fd normally runs as user *root*)
